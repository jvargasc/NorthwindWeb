...
const resultCallBackCustomers = (json) => {
    tmpJson = JSON.stringify(json);
}

const userActionCustomers = async (url) => {
...
document.getElementById("tblModalCustomer").addEventListener("click", function () {
...
//    //undefined
//    //d.value = 'sdfsd'
    highlight_rowCustomers();
});


function highlight_rowCustomers() {
    var table = document.getElementById('tblModalCustomer');
...
const showCustomers = async (baseUrl) => {

    let url = baseUrl + '/api/customers/getcustomers';

    //alert(await userAction(url).then((json) => { return JSON.stringify(json) }));
    let alertaVar = JSON.parse(await userActionCustomers(url).then((json) => { return JSON.stringify(json) }));
    ...
    var divContainer = document.getElementById("tblModalCustomer");
    divContainer.innerHTML = "";
    divContainer.appendChild(table);
    document.getElementById("tblModalCustomer");

}

const searchCustomers = async (baseUrl) => {
    alert("searchCustomers ()");
}
